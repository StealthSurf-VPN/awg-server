...
- Test release and deployment automation: `bash scripts/release-marker_test.sh && bash scripts/release-notes_test.sh && bash scripts/deploy-awg-server_test.sh`
...
- CI, automated release, and protected deployment: `docs/ci-cd.md`
